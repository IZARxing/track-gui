...
"background-color: rgba(0, 76, 255, 80);\n"
"border: 0px solid #42adff;\n"
...
"    font-size: 15px;\n"
"    color: #e8e8e8;\n"
"border-image: url(:/img/icon/设置.png);}")
        ...
        self.label_9.setStyleSheet("font: 25 6pt \"Adobe 黑体 Std L\";\n"
"color:rgb(120, 0, 180)")
        self.label_9.setObjectName("label_9")
        self.horizontalLayout_35.addWidget(self.label_9)
        self.maButton = QtWidgets.QPushButton(self.groupBox_2)
        self.maButton.setStyleSheet("QPushButton{font-family: \"Microsoft YaHei\";\n"
"font-size: 14px;\n"
"font-weight: bold;\n"
"color:white;\n"
...
"background-color: rgba(48,148,243,80);}")
        self.maButton.setText("")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/img/icon/关于.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.maButton.setIcon(icon4)
        self.maButton.setIconSize(QtCore.QSize(30, 30))
        self.maButton.setObjectName("maButton")
        self.horizontalLayout_35.addWidget(self.maButton)
...
"border-image: url(:/img/icon/下拉箭头.png);\n"
"}\n"
"")
...
"    font-family: \"DejaVu Sans Mono\";\n"
"border-image: url(:/img/icon/视频.png);\n"
"    font-size: 15px;\n"
"    color: #e1e1e1;}")
...
"background-color: rgba(223, 223, 223, 150);}")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/img/icon/运行.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon8.addPixmap(QtGui.QPixmap(":/img/icon/暂停.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon8.addPixmap(QtGui.QPixmap(":/img/icon/运行.png"), QtGui.QIcon.Disabled, QtGui.QIcon.Off)
        icon8.addPixmap(QtGui.QPixmap(":/img/icon/暂停.png"), QtGui.QIcon.Disabled, QtGui.QIcon.On)
        icon8.addPixmap(QtGui.QPixmap(":/img/icon/运行.png"), QtGui.QIcon.Active, QtGui.QIcon.Off)
        icon8.addPixmap(QtGui.QPixmap(":/img/icon/暂停.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        icon8.addPixmap(QtGui.QPixmap(":/img/icon/运行.png"), QtGui.QIcon.Selected, QtGui.QIcon.Off)
        icon8.addPixmap(QtGui.QPixmap(":/img/icon/暂停.png"), QtGui.QIcon.Selected, QtGui.QIcon.On)
        ...
        self.progressBar.setStyleSheet("QProgressBar{ color: rgb(255,255,255); font:12pt; border-radius:2px; text-align:center; border:none; background-color: rgba(0, 0, 0,100);} \n"
...
"background-color: rgba(223, 223, 223, 150);}")
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/img/icon/终止.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "基于YOLOv5和DeepSORT的行人检测跟踪系统"))
        self.label_4.setText(_translate("mainWindow", "基于YOLOv5和DeepSORT的行人检测跟踪系统v1.0"))
        ...
        self.rtspButton.setToolTip(_translate("mainWindow", "实时网络监控"))
        self.label_8.setText(_translate("mainWindow", "隔帧延时"))
        ...
        self.label_11.setText(_translate("mainWindow", "人流量统计"))
