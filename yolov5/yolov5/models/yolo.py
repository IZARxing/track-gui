...
from models.common import Conv, Bottleneck, SPP, SPPCSP, DWConv, Focus, BottleneckCSP, BottleneckCSP2, Concat, NMS
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [Conv, Bottleneck, SPP, SPPCSP, DWConv, MixConv2d, Focus, CrossConv, BottleneckCSP, BottleneckCSP2, C3]:
            c1, c2 = ch[f], args[0]
